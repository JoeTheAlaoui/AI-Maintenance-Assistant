...
export function AssetsTableWithSubAssets({ assets }: AssetsTableWithSubAssetsProps) {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            ...
            toast({
                title: 'Success',
                description: `Successfully deleted ${selectedAssets.size} asset(s)`,
            })
    ...
    return (
        <div className="space-y-4">
            {selectedAssets.size > 0 && (
                <div className="flex items-center justify-between p-4 bg-muted rounded-lg border-2 border-primary">
